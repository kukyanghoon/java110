...
-- 강의
DROP TABLE IF EXISTS p1_lec RESTRICT;

-- 강의배정
DROP TABLE IF EXISTS p1_lec_tchr RESTRICT;

-- 수강생
DROP TABLE IF EXISTS p1_lec_stud RESTRICT;
...
-- 강의
ALTER TABLE p1_lec
    ADD CONSTRAINT PK_p1_lec -- 강의 기본키
        PRIMARY KEY (
            lno -- 강의번호
        );
...
-- 강의배정
ALTER TABLE p1_lec_tchr
    ADD CONSTRAINT PK_p1_lec_tchr -- 강의배정 기본키
        PRIMARY KEY (
            tno, -- 강사번호
            lno  -- 강의번호
        );
...
-- 수강생
ALTER TABLE p1_lec_stud
    ADD CONSTRAINT PK_p1_lec_stud -- 수강생 기본키
        PRIMARY KEY (
            sno, -- 학생번호
            lno  -- 강의번호
        );
...
-- 강의
ALTER TABLE p1_lec
    ADD CONSTRAINT FK_p1_mgr_TO_p1_lec -- 매니저 -> 강의
        FOREIGN KEY (
            mgno -- 매니저번호
        )
...
-- 강의배정
ALTER TABLE p1_lec_tchr
    ADD CONSTRAINT FK_p1_tchr_TO_p1_lec_tchr -- 강사 -> 강의배정
        FOREIGN KEY (
            tno -- 강사번호
        )
...
-- 강의배정
ALTER TABLE p1_lec_tchr
    ADD CONSTRAINT FK_p1_lec_TO_p1_lec_tchr -- 강의 -> 강의배정
        FOREIGN KEY (
            lno -- 강의번호
        )
        REFERENCES p1_lec ( -- 강의
            lno -- 강의번호
        );

-- 수강생
ALTER TABLE p1_lec_stud
    ADD CONSTRAINT FK_p1_stud_TO_p1_lec_stud -- 학생 -> 수강생
        FOREIGN KEY (
            sno -- 학생번호
        )
...
-- 수강생
ALTER TABLE p1_lec_stud
    ADD CONSTRAINT FK_p1_lec_TO_p1_lec_stud -- 강의 -> 수강생
        FOREIGN KEY (
            lno -- 강의번호
        )
        REFERENCES p1_lec ( -- 강의
