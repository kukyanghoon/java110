...
public class Test20 {
    ...
    // 방법 1) DD파일에 프론트 컨트롤러를 선언할 떄 다음의 태그를 설정해야 한다.
    // <multipart-config>
    //      <max-file-size>2000000</max-file-size>
    // </multipart-config>
    
    // 방법 2) Apache common fileupload를 이용하여 멀티파트 데이터를 처리하는 스프링 제공 객체를 추가한다.
    // => XML 설정 : multipartResolver라는 이름으로 다음과 같이 객체를 등록한다.
