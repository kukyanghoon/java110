/*리스너 만들기
 * - 클라이언트가 시작할때 최초로 만들어짐
 * - 리스너(listener)란? 특정 상황에 놓이면 실행되는 객체이다.
...
public class Listener02 implements ServletRequestListener{
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        System.out.println("Listener02.contextInitialized()호출됨");
    ...
    public void requestDestroyed(ServletRequestEvent sre) {
        ...
        System.out.println("Listener02.contextDestroyed()호출됨");
