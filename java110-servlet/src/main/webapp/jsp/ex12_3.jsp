...
<body>
    ...
    &lt;jsp:useBean scope="request" id="list1" class="java.util.ArrayList"%>
         위의 태그는 다음과 같이 동작하는 자바코드로 변환된다.
         자바코드 :
    java.util.ArrayList list1 = (java.util.ArrayList)pageContext.getAttribute("list1");
    if(names1==null)
    {
	...
	<%--
	자바코드 :
    java.util.ArrayList names2 = (java.util.ArrayList)pageContext.getAttribute("names2");
    if(names2==null)
    {
       names2 = new java.lang.String();
       request.setAttribute("names2", names2);
    }
	 --%>
	<p>names1.get(1) : <%=list1.get(1)%></p>
