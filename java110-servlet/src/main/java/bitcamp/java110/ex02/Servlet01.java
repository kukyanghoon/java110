/*서블릿 만들기
 *  -javax.servlet.Servlet 인터페이스 그현
 * 
 * 
 */
...
public class Servlet01 implements Servlet{
    ...
    public ServletConfig getServletConfig() {
        ...
        // 그래서 이 메서드는 init()에서 파라미터로 받은 ServletConfig객체를 리터해야 한다.
        // 잘 보관해 두었다가 호출될 때 리턴해야한다.
        return null;
    }
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 예을 들면, 게시물 목록을 출력하거나 로그인을 처리하거나 회원가입을 처리하는 등......
    ...
    public void destroy() {
        ...
        // 그래서 이 메서드 에서는 init()에서 준비한 자원을 해제시키는 일을 한다.
        // 예를 들면, DB커넥션을 닫는다거나 소켓 연결을 닫는 등의 작업을 수행한다.
...
// - 클라이언트마다 구분해서 저장해야 한다면,
//   서블릿의 인스턴스 변수를 사용해서는 안된다.
//   왜? 서블릿 객체는 한개만 생성되고 모든 클라이언트가 공유한다. 
