...
public class Test23 {
    ...
    public String m1(Model model) throws Exception{
        ...
        // (물론 아무런 의미가 없겠지만)
        // 이것을 방지하게위해 보통 JSP 파일을 WEB-INF폴더 아래에 둔다
        
        // 문제는 /WEB-INF 폴더 아래에 JSP파일을 두게 되면,
        // 리턴 URL을 작성하는데 너무 길어서 번거롭다.
        ...
        // request handler엣는 공통 경로를 제외한 나머지 경로만 지정하기 때문에
        // 편리하다
        return "ex03/Test23";
    }
